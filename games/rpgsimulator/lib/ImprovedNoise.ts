class Perlin {
	...
	public OctavePerlin(x, y, z, octaves, persistence) {
		var total = 0;
		var frequency = 1;
		var amplitude = 1;
	...
	private static readonly permutation = [151,160,137,91,90,15,					// Hash lookup table as defined by Ken Perlin.  This is a randomly
	...
	private static p; 													// Doubled permutation to avoid overflow
